package
{
	...
	public class Context3D_drawToBitmapData extends Sprite
	{
		...
		private function contextCreated( event:Event ):void
		{
			...
			renderContext.setScissorRectangle(new Rectangle(100, 0, 250, 400));
			renderContext.drawTriangles( indexList, 0, 2 );
			
			var renderedBitmapData:BitmapData = new BitmapData( 250, 200, true );
			renderContext.drawToBitmapData( renderedBitmapData );
			renderContext.setScissorRectangle(null);
