...
package com.core.utils {
	...
	public class Procedure {
		 ...
		 * @private
		 */
		copper3d static const crc32Table:Vector.<uint> = createCRC32Table();
		 ...
		 * @private
		 */
		copper3d var reservedConstants:uint = 0;
		 ...
		 * @private
		 */
		copper3d static function createCRC32(byteCode:ByteArray):uint {
			byteCode.position = 0;
