...
package com.core.utils {
	...
	public class BoundBox {
		 ...
		 * @private
		 */
		copper3d function checkFrustumCulling(frustum:CullingPlane, culling:int):int {
			var side:int = 1;
		 ...
		 * @private
		 */
		/*copper3d function checkOcclusion(occluders:Vector.<Occluder>, occludersLength:int, transform:Transform3D):Boolean {
		 ...
		 * @private
		 */
		copper3d function checkRays(origins:Vector.<Vector3D>, directions:Vector.<Vector3D>, raysLength:int):Boolean {
		 ...
		 * @private
		 */
		copper3d function checkSphere(sphere:Vector3D):Boolean {
